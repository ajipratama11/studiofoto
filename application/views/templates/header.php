...
<head>
    ...
    <link href="<?= base_url() ?>vendor/admin/assets/libs/jquery-steps/jquery.steps.css" rel="stylesheet">
    <link href="<?= base_url() ?>vendor/admin/assets/libs/jquery-steps/steps.css" rel="stylesheet">
